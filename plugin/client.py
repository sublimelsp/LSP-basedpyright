...
@final
class LspBasedpyrightPlugin(LspPlugin):
    server_version: str = ""
    ...
    def on_pre_start_async(cls, context: OnPreStartContext) -> None:
        ...
        NodeManager.on_pre_start_async(
            ...
            Path("node_modules", "basedpyright", "langserver.index.js"),
    ...
    def handle_venv_strategies(
        ...
        basedpyright_section = ConfigurationSection("basedpyright")
        if python_section in configuration_proxy.section or basedpyright_section in configuration_proxy.section:
            ...
            if (venv_strategies := session.config.settings.get("venvStrategies")) and (
                ...
                if basedpyright_section in configuration_proxy.section:
                    site_packages_dir = str(venv_info.site_packages_dir)
                    extra_paths: list[str] = configuration_proxy.get(SERVER_SETTING_ANALYSIS_EXTRAPATHS)
